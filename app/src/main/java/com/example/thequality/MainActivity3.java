...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_deteksi);
        ...
        imageCapture.takePicture(ContextCompat.getMainExecutor(this),
                new ImageCapture.OnImageCapturedCallback() {
                    ...
                    public void onCaptureSuccess(@NonNull ImageProxy imageProxy) {
                        ...
                        runOnUiThread(() -> {
                            ...
                            if (gray < 100) {
                                ...
                                tvKelayakan.setTextColor(ContextCompat.getColor(MainActivity3.this, android.R.color.holo_red_dark));
                            } else {
                                tvKelayakan.setText("Status: Baik / Layak");
                                tvKelayakan.setTextColor(ContextCompat.getColor(MainActivity3.this, android.R.color.holo_green_dark));
                            }
                        });
                    }
                    ...
                    public void onError(@NonNull ImageCaptureException exception) {
                        Toast.makeText(MainActivity3.this, "Gagal memproses gambar", Toast.LENGTH_SHORT).show();
                    }
                });
    }
