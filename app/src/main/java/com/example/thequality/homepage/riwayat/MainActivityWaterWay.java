...
public class MainActivityWaterWay extends AppCompatActivity {
        ...
        databaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (listHasil.isEmpty()) {
                    Toast.makeText(MainActivityWaterWay.this, "Belum ada data riwayat.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MainActivityWaterWay.this, "Gagal memuat: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
